  ...
  return (
    <div className="App">
      ...
      <div class="container mt-3">
        ...
        <form action="/action_page.php" class="was-validated" style={{marginLeft: "40vh"}}>
          <div class="mb-3 mt-3">
          ...
          <div class="mb3 mt-3">
            ...
            <div class="col-sm-10">          
              <input type="textarea" style={{height: "20vh"}} class="form-control" id="asunto" placeholder="Ingrese el mensaje" name="asunto" required/>
